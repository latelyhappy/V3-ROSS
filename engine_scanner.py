...
def update_scanner_loop():
    print("🚀 [SCANNER] 啟動 100% TV 官方純化直連引擎 (過濾成交量 > 100K)...")
    ...
    while True:
        try:
            ...
            with shared_state.brain_lock:
                ...
                shared_state.TV_LOGIN_STATUS = "✅ 雷達全開 (TV 直連 > 100K 淨化版)"
